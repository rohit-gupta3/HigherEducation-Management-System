                    ...
                    <div class="row">
                            <div class="col-md-12">
                                <div class="page-header">
                                    <h2>List of the students who are approved for the Letter.</h2>
                                </div>
                                <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    $query="SELECT * FROM studentdetails INNER JOIN appliedstudents on studentdetails.redgno = appliedstudents.redgno WHERE fname='$fname' and approved='YES';"; 
