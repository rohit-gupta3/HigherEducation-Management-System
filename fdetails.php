        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div><h2>You can Search Details of any Student:</h2></div>
                    <div>
                    <form action="viewdetails.php?id=`$_GET['id']`" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-300 navbar-search">
