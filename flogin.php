<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT * FROM facultylogin WHERE userid = '$myusername' and password = '$mypassword'";
...
<body>
    ...
    <div class="slogin">
        ...
        <div style="text-align:center; font-size:22px; background-color:rgb(13, 13, 122);color:white; ">Faculty Login</div>
