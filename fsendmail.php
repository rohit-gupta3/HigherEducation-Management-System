<?php
    ...
    {
        $redg = $_POST['registration'];
        $email = $_POST['email'];
        $message = $_POST['message'];
        $to = "guptarohitkumar2580@gmail.com";
        $subject = "HTML email";
        ...
        // $headers .= 'From:guptarohitkumar2580@gmail.com'."\r\n";
        // $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n"; 
        // More headers
        // $headers .= 'From: <webmaster@example.com>' . "\r\n";
        // $headers .= 'Cc: myboss@example.com' . "\r\n";
        $sql = "INSERT INTO facultymessage (fname, studentname, redgno, message ) VALUES ('JayaKumar', 'ROHIT', '$redg', '$message');";
        // try{
        ...
        // catch(Exception $e)
        // {
        //     $_SESSION['error'] ="Something is Wrong.<br>Try Connecting to Internet";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div><h2>You Can Send Mail Here:</h2></div>
                    <div>
                    <div class="container px-5 my-5">
                        <form action="fsendmail.php" method="post" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            <div class="form-floating mb-3">
                                <input class="form-control" id="registrationNumber" type="text" name="registration" placeholder="Registration Number" data-sb-validations="required" />
                            ...
                            <div class="d-grid">
                                <input class="btn btn-primary" id="submitButton" type="submit" name="submit" value="Send">
                            </div>
                        </form>
                    </div>
