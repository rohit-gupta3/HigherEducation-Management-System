...
<head>
    ...
    <style>
        ...
        *{padding:0;margin:0}
        .wrapper{height:600px;display:flex;justify-content:center;align-items:center;background-color:#eee}
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   <?php
                        if($uploaded>0)
                        {
                            echo '<h2>Your documents are generated. Please Check Your Letters</h2><div class="wrapper"> <svg class="checkmark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52"> <circle class="checkmark__circle" cx="26" cy="26" r="25" fill="none"/> <path class="checkmark__check" fill="none" d="M14.1 27.2l7.1 7.2 16.7-16.8"/>
                            </svg>
                            </div>';
                        }
                        else if($approved>0)
                        {
                            echo '<center><h3>Great Your Letters are on the way Please for Some Time Till faculty Upload Your documents</h3><img src="./img/waiting.jpg"><div class="lds-hourglass"></div></center>';
                        }
                        else{
                            echo '<h3>You have to request with your Faculty to get your Documents</h3>';
                        }
                   ?>
