...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div><h2 style="color:red;">You are editing your details</h2></div>
                    <div>
                        <div class="container px-4 my-4">
                            <form id="contactForm" method="post" onsubmit="return validating()" data-sb-form-api-token="API_TOKEN">
                                <div class="mb-3">
                                    <?php
                                    ...
                                    <input class="form-control" id="title" type="text" name="title" value="<?php echo $row['gender']?>"placeholder="Full Name" data-sb-validations="required" />
                                    <label class="form-label" for="fullName">Full Name</label>
                                    <input class="form-control" id="fullName" type="text" name="name" value="<?php echo $row['Name']?>" placeholder="Full Name" data-sb-validations="required" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="registrationNumber" type="text" value="<?php echo $row['redgno']?>" name="registration" placeholder="Registration Number" data-sb-validations="required" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="cgpa" type="text" value="<?php echo $row['cgpa']?>" name="cgpa" placeholder="CGPA" data-sb-validations="required" />
                                    <div class="invalid-feedback" data-sb-feedback="cgpa:required">CGPA is required.</div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="mobileNumber">Mobile Number</label>
                                    <input class="form-control" id="mobileNumber" type="text" value="<?php echo $row['Mobile']?>" name="mobile" placeholder="Mobile Number" data-sb-validations="required" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="mobileNumber" type="email" value="<?php echo $row['email']?>" name="email" placeholder="Email" data-sb-validations="required" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="aadharCardNumber" type="text" value="<?php echo $row['adharno']?>" name="aadhar" placeholder="AadharCard Number" data-sb-validations="required" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="passedYear" type="text" name="passed" value="<?php echo $row['passedyear']?>" placeholder="Passed Year" data-sb-validations="required" />
                                    <div class="invalid-feedback" data-sb-feedback="passedYear:required">Passed Year is required.</div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="dateOfBirth">Date of Birth</label>
                                    <input class="form-control" id="dateOfBirth" type="text" name="dob" value="<?php echo $row['dob']?>" placeholder="Date of Birth" data-sb-validations="required" />
                                    <div class="invalid-feedback" data-sb-feedback="dateOfBirth:required">Date of Birth is required.</div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="address">Address</label>
                                    <input class="form-control" id="address" type="text" name="address" value="<?php echo $row['address']?>" placeholder="Address" data-sb-validations="required" />
                                    <div class="invalid-feedback" data-sb-feedback="address:required">Address is required.</div>
                                </div>                                
                                <div class="d-grid">
                                    <input class="btn btn-primary btn-lg" id="submitButton" type="submit" value="Update">
                                </div>
                            </form>
                        </div>
                        <?php
    ...
    function validating()
    {
        ...
        var aadhar = document.getElementById("cgpa").value;
        var registration = document.getElementsById("cgpa").value;
        if( gpa="")
        {
